...
function Footer() {
  return (
    <div>
      <h4 className='title text-center font-italic'>Conclusiones</h4>
...
YouTube y tratando de mejorar la lógica se logro realizar los programas. Todos los
programas los realice con Python dado que es un lenguaje de programación muy versátil
para la realización de muchísimas actividades y su desempeño en la mayoría de los
problemas es muy excepcional. Poder analizar los diferentes tipos de procesos y
